...
public abstract class FileContentProcessor {
    ...
    protected abstract String processingMethod(FileReader file1, FileReader file2, FileReader file3,
                                               String fileName1, String fileName2, String fileName3) throws IOException;

    public void processFileContent(String fileName1, String fileName2, String fileName3, String fileName4) throws IOException {
